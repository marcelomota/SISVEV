...
$document->addStyleSheet(JURI::base().'modules/mod_siab_c/tmpl/css/materialize.css');
$document->addScript(JURI::base().'modules/mod_siab_c/tmpl/js/materialize.js');
...
if (isset($_POST['OK']))
{
	...
	$cep = $_POST['cep'];
	$bairro =$_POST['bairro'];
	$cidade = ModCadastroSiab::getCodigoCidade($_POST['codmunicipio']);
	$uf= $_POST['ufinform'];
    
	$resultado = ModCadastroSiab::cadastrar($novoNome,$dtnasc,$estcivil,$escol,$logradouro,$numero,$complemento,$cep,$bairro,$cidade,$uf);
	$controle = ModCadastroSiab::insertControle($novoNome);
	echo "SIAB CADASTRO?";
}
