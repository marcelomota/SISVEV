...
$document->addStyleSheet(JURI::base().'modules/mod_sim_c/tmpl/css/materialize.css');
$document->addScript(JURI::base().'modules/mod_sim_c/tmpl/js/materialize.js');
...
if (isset($_POST['OK']))
{
	...
	$cep = $_POST['cep'];
	$bairro =$_POST['bairro'];
	$cidade = ModCadastroSim::getCodigoCidade($_POST['codmunicipio']);
	$uf= $_POST['ufinform'];
    
	$resultado = ModCadastroSim::cadastrar($novoNome,$dtnasc,$estcivil,$escol,$logradouro,$numero,$complemento,$cep,$bairro,$cidade,$uf);
